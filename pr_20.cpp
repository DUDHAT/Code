 ...
 void date()
  {
    ...
    if(no==1)
    {
        ...
        {
            cout<<" 40% less in new bettery......"<<800*40/100;
        }
        else if(month4>30 && month4<=36)
        {
            cout<<"30% less in new bettery......"<<800*30/100;
        }
        else if(month4>36 && month4<=42)
        {
            cout<<" 20% less in new bettery....."<<800*20/100;
        }
        else if(month4>42 && month4<=48)
        {
            cout<<"10% less in new bettery......"<<800*10/100;
        }
        else if(month4>48)
        {
    ...
    else if(no==3)
    {
        ...
        {
            cout<<"bettery 40% off in new bettery...."<<3200*40/100;
        }
        else if(month4>24 && month4<=36)
        {
            cout<<"bettery 30% off in new bettery...."<<3200*30/100;
        }
        else if(month4>36 && month4<=42)
        {
            cout<<"bettery 20% off in new bettery....."<<3200*20/100;
        }
        else if(month4>42 && month4<=48)
        {
            cout<<"bettery 10% off in new bettery....."<<3200*10/100;
        }
        else if(month4>48)
        {
